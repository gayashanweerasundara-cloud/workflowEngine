...
const workflow_template_entity_1 = require("../domain/entities/workflow-template.entity");
const workflow_step_entity_1 = require("../domain/entities/workflow-step.entity");
let TemplateModule = class TemplateModule {
};
exports.TemplateModule = TemplateModule;
exports.TemplateModule = TemplateModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([workflow_template_entity_1.WorkflowTemplate, workflow_step_entity_1.WorkflowStep])],
